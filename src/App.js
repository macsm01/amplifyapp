...
function App({ signOut, user }) {
  ...
  // function for generating random alphabetic IDs.
  ...
  // function for generating random numeric IDs.
  ...
  // function for generating random IBAN in the standard format.
  ...
  // function for getting a random bank name from a list of banks worldwide
  ...
  // function to generate one random payment message
  ...
  // form submission handler with async call to the AWS REST API.
  let handleSubmit = async (e) => {
    ...
    try {
        ...
        // Reset form values after successful REST API call.
